...
knitr::opts_chunk$set(echo = TRUE, fig.align = "center", fig.path = "../figures/01_DADA2")
```
...
```
#Ran these commands to symbollically link fastq files
...
#Intuition check - Need to have equal number of forward and reverse reads
...
random_samples
#Calculate and plot quality of 12 samples
...
reverse_filteredQual_plot_12 <-
  ...
  labs(title = "Reverse Rads: Raw Quality")
...
[insert interpretation of forward and reverse qual plots]
